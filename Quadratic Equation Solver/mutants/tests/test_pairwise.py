...
def load_test_set():
    ...
    possible_paths = [Path(__file__).resolve().parents[1] / "TestSets" / "PairWiseTestSet.csv", Path(__file__).resolve().parents[2] / "TestSets" / "PairWiseTestSet.csv"]
